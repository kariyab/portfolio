            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <label class="col-md-6" for="role">確認のためチェックをいれてください</label>
                            <input id="role" type="checkbox" class="form-check @error('role') is-invalid @enderror" 
                            name="role" value="10" required autocomplete="role">
                            @error('role')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
